...
// 	window_height=screen_height/2;
	...
	if(!PX_RuntimeInitialize(runtime,800,600,800,600,PX_ApplicationRuntime,sizeof(PX_ApplicationRuntime),PX_APPLICATION_MEMORYPOOL_UI_SIZE,PX_APPLICATION_MEMORYPOOL_RESOURCES_SIZE,PX_APPLICATION_MEMORYPOOL_GAME_SIZE))
		return PX_FALSE;
	return PX_TRUE;
}
